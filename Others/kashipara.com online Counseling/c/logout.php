...
try{
    ...
    $stm=$dbh->prepare("insert into systemlog values('$adminid','$date','$logouttime','$sessionid','$studenlist','$reportingcenters','$Addinstituename','$updateavailabelsheat','$Allocatesheat','$enterrank','$seatstatues')");
